...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&Supply{}, "osmosis-sdk/Supply", nil)
	cdc.RegisterConcrete(&MsgSend{}, "osmosis-sdk/MsgSend", nil)
	cdc.RegisterConcrete(&MsgMultiSend{}, "osmosis-sdk/MsgMultiSend", nil)
}
