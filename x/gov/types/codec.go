...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&MsgSubmitProposal{}, "osmosis-sdk/MsgSubmitProposal", nil)
	cdc.RegisterConcrete(&MsgDeposit{}, "osmosis-sdk/MsgDeposit", nil)
	cdc.RegisterConcrete(&MsgVote{}, "osmosis-sdk/MsgVote", nil)
	cdc.RegisterConcrete(&TextProposal{}, "osmosis-sdk/TextProposal", nil)
}
