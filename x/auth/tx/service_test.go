...
import (
	...
	clienttx "github.com/cosmos/osmosis-sdk/client/tx"
	...
	"github.com/cosmos/osmosis-sdk/types/query"
	...
	for _, tc := range testCases {
		s.Run(tc.name, func() {
			...
			if tc.expErr {
				...
				// ref: https://github.com/cosmos/osmosis-sdk/issues/8680
				// ref: https://github.com/cosmos/osmosis-sdk/issues/8681
