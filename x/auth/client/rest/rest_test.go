...
import (
	...
	"github.com/cosmos/osmosis-sdk/crypto/hd"
	"github.com/cosmos/osmosis-sdk/crypto/keyring"
	kmultisig "github.com/cosmos/osmosis-sdk/crypto/keys/multisig"
	cryptotypes "github.com/cosmos/osmosis-sdk/crypto/types"
	"github.com/cosmos/osmosis-sdk/testutil"
	clitestutil "github.com/cosmos/osmosis-sdk/testutil/cli"
	"github.com/cosmos/osmosis-sdk/testutil/network"
	"github.com/cosmos/osmosis-sdk/testutil/testdata"
	sdk "github.com/cosmos/osmosis-sdk/types"
	"github.com/cosmos/osmosis-sdk/types/rest"
	txtypes "github.com/cosmos/osmosis-sdk/types/tx"
	"github.com/cosmos/osmosis-sdk/types/tx/signing"
	authclient "github.com/cosmos/osmosis-sdk/x/auth/client"
	authcli "github.com/cosmos/osmosis-sdk/x/auth/client/cli"
	authrest "github.com/cosmos/osmosis-sdk/x/auth/client/rest"
	authtest "github.com/cosmos/osmosis-sdk/x/auth/client/testutil"
	"github.com/cosmos/osmosis-sdk/x/auth/legacy/legacytx"
	bankcli "github.com/cosmos/osmosis-sdk/x/bank/client/testutil"
	"github.com/cosmos/osmosis-sdk/x/bank/types"
	ibccli "github.com/cosmos/osmosis-sdk/x/ibc/core/04-channel/client/cli"
	ibcsolomachinecli "github.com/cosmos/osmosis-sdk/x/ibc/light-clients/06-solomachine/client/cli"
)
...
// a tx with "osmosis-sdk/MsgTransfer" using the SDK, we just hardcode the tx
// here. But external clients might, see https://github.com/cosmos/osmosis-sdk/issues/8022.
...
// ref: https://github.com/cosmos/osmosis-sdk/issues/8679
