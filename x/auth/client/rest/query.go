...
import (
	...
	clientrest "github.com/cosmos/osmosis-sdk/client/rest"
	...
	genutilrest "github.com/cosmos/osmosis-sdk/x/genutil/client/rest"
)
...
func QueryAccountRequestHandlerFn(storeName string, clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			// Ref: https://github.com/cosmos/osmosis-sdk/issues/4923
