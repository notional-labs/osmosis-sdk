...
import (
	...
	snapshottypes "github.com/cosmos/osmosis-sdk/snapshots/types"
	"github.com/cosmos/osmosis-sdk/store/rootmulti"
	store "github.com/cosmos/osmosis-sdk/store/types"
...
func registerTestCodec(cdc *codec.LegacyAmino) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "osmosis-sdk/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "osmosis-sdk/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "osmosis-sdk/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgKeyValue{}, "osmosis-sdk/baseapp/msgKeyValue", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "osmosis-sdk/baseapp/msgNoRoute", nil)
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "osmosis-sdk/baseapp/msgNoDecode", nil)
