...
| `create_validator.validator='cosmosval1...'`     | x/staking-specific Event, see [x/staking SPEC](../../../osmosis-sdk/x/staking/spec/07_events.md).                                                         |
...
+++ https://github.com/cosmos/osmosis-sdk/blob/v0.42.1/types/events.go#L17-L25
...
+++ https://github.com/cosmos/osmosis-sdk/blob/v0.42.1/types/events.go#L33-L37
