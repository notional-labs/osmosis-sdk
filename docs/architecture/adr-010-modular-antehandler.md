...
- [#4572](https://github.com/cosmos/osmosis-sdk/issues/4572):  Modular AnteHandler Issue
- [#4582](https://github.com/cosmos/osmosis-sdk/pull/4583): Initial Implementation of Per-Module AnteHandler Approach
