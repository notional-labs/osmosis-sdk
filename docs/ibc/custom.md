...
interface](https://github.com/cosmos/osmosis-sdk/tree/release/v0.42.x/x/ibc/core/05-port/types/module.go). This
...
simple version negotation is implemented in the [ibc-transfer module](https://github.com/cosmos/osmosis-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/module.go).
...
[`OnRecvPacket`](https://github.com/cosmos/osmosis-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/module.go).
:::
...
[channel types](https://github.com/cosmos/osmosis-sdk/tree/release/v0.42.x/x/ibc/core/04-channel/types).

While modules may choose arbitrary acknowledgement structs, a default acknowledgement types is provided by IBC [here](https://github.com/cosmos/osmosis-sdk/tree/release/v0.42.x/proto/ibc/core/channel/v1/channel.proto):
...
[Binding to transfer
port](https://github.com/cosmos/osmosis-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/genesis.go)

[Sending transfer
packets](https://github.com/cosmos/osmosis-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/keeper/relay.go)

[Implementing IBC
callbacks](https://github.com/cosmos/osmosis-sdk/tree/release/v0.42.x/x/ibc/applications/transfer/module.go)
